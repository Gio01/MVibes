    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method=POST action="<?php echo base_url() ?>index.php/Loginc/logginin" method="GET">
                    ...
                    <div class="w-full text-center">
                        <a href="http://localhost:8888/MVibes/index.php/register" class="txt3">
                            Sign Up
                        </a>
                    </div>
                </form>

                <div class="login100-more" style="background-image: url('https://images.unsplash.com/photo-1488109811119-98431feb6929?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80') "> </div>
            </div>
        </div>
    </div>
